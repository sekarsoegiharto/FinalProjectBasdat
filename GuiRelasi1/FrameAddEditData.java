...
public class FrameAddEditData extends javax.swing.JFrame {
    ...
    public FrameAddEditData(String NamaToko, String AlamatToko, String NoTelpToko, int status) {
        initComponents();
        this.status = status;
        this.primaryKey = NamaToko;
        txtNamaToko.setText(NamaToko);
        txtAlamatToko.setText(AlamatToko);
        txtNoTelpToko.setText(NoTelpToko);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(44, 44, 44)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNamaToko, javax.swing.GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String NoTelpToko = txtNoTelpToko.getText();
        ...
        if (status == 0) {
            try {
                ...
                java.sql.PreparedStatement state = con.prepareStatement("INSERT INTO relasi1 VALUES ('" + NamaToko + "','" + AlamatToko + "'," + NoTelpToko + ")");
                state.execute();
                JOptionPane.showMessageDialog(this, "Sukses memasukkan data");
                txtNamaToko.setText("");
                txtAlamatToko.setText("");
                txtNoTelpToko.setText("");
            } catch (Exception e) {
            ...
            try {
                ...
                String dburl = "jdbc:sqlserver://localhost:1433;databaseName=Basdat;encrypt=true;trustServerCertificate=true;user=sa;password=123456";
                java.sql.Connection con = DriverManager.getConnection(dburl);
                java.sql.PreparedStatement state = con.prepareStatement("UPDATE relasi1 SET Nama_Toko = '" + NamaToko + "', Alamat_Toko = '" + AlamatToko + "', No_Telp_Toko = " + NoTelpToko + " WHERE Nama_Toko = '" + primaryKey + "';");
                state.execute();
