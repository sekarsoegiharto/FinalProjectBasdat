...
public class FrameMiddleData extends javax.swing.JFrame {
    ...
    public FrameMiddleData(int indexData, int jumlahData, String arrData[][]) {
        ...
        if (indexData >= 0 && indexData <= jumlahData) {
            ...
            txtNamaBarang.setText(arrData[indexData][1]);
            txtJumlahBarang.setText(arrData[indexData][2]);
            txtHargaJumlah.setText(arrData[indexData][3]);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        // TODO add your handling code here:
        new FrameAddEditData(txtNoTransaksi.getText(), txtNamaBarang.getText(), txtJumlahBarang.getText(), txtHargaJumlah.getText(), 1).setVisible(true);
        this.setVisible(false);
