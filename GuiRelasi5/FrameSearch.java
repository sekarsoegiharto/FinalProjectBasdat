...
public class FrameSearch extends javax.swing.JFrame {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(44, 44, 44)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtHargaTotal, javax.swing.GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE)
                            .addComponent(txtEDC)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
        String query = "";
        if (!txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && !txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND EDC LIKE '%" + txtEDC.getText() + "%' AND Jumlah_Barang = '" + txtBayar.getText() + "' AND Harga_Jumlah = '" + txtKembalian.getText() + "';";
        } else if (!txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && !txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND EDC LIKE '%" + txtEDC.getText() + "%' AND Jumlah_Barang = '" + txtBayar.getText() + "';";
        } else if (!txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND EDC LIKE '%" + txtEDC.getText() + "%' AND Kembalian = '" + txtKembalian.getText() + "';";
        } else if (!txtHargaTotal.getText().equals("") && txtEDC.getText().equals("") && !txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND Bayar = '" + txtBayar.getText() + "' AND Kembalian = '" + txtKembalian.getText() + "';";
        } else if (txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && !txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE EDC LIKE '%" + txtEDC.getText() + "%' AND Bayar = '" + txtBayar.getText() + "' AND Kembalian = '" + txtKembalian.getText() + "';";
        } else if (!txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND EDC LIKE '%" + txtEDC.getText() + "%';";
        } else if (!txtHargaTotal.getText().equals("") && txtEDC.getText().equals("") && !txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND Bayar = '" + txtBayar.getText() + "';";
        } else if (!txtHargaTotal.getText().equals("") && txtEDC.getText().equals("") && txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%' AND Kembalian = '" + txtKembalian.getText() + "';";
        } else if (txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && !txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE EDC LIKE '%" + txtEDC.getText() + "%' AND Bayar = '" + txtBayar.getText() + "';";
        } else if (txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE EDC LIKE '%" + txtEDC.getText() + "%' AND Kembalian = '" + txtKembalian.getText() + "';";
        } else if (txtHargaTotal.getText().equals("") && txtEDC.getText().equals("") && !txtBayar.getText().equals("") && !txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Bayar = '" + txtBayar.getText() + "' AND Kembalian = '" + txtKembalian.getText() + "';";
        } else if (!txtHargaTotal.getText().equals("") && txtEDC.getText().equals("") && txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE Harga_Total LIKE '%" + txtHargaTotal.getText() + "%';";
        } else if (txtHargaTotal.getText().equals("") && !txtEDC.getText().equals("") && txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
            query = "SELECT * FROM relasi5 WHERE EDC LIKE '%" + txtEDC.getText() + "%';";
        } else if (txtHargaTotal.getText().equals("") && txtEDC.getText().equals("") && !txtBayar.getText().equals("") && txtKembalian.getText().equals("")) {
